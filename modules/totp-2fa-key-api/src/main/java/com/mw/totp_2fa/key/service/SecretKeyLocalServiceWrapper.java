 ...
 * @generated
 */
public class SecretKeyLocalServiceWrapper
	implements SecretKeyLocalService, ServiceWrapper<SecretKeyLocalService> {
	...
	public com.liferay.portal.kernel.model.PersistedModel createPersistedModel(
		...
		return _secretKeyLocalService.createPersistedModel(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public com.mw.totp_2fa.key.model.SecretKey createSecretKey(
		long secretKeyId) {
	...
	public <T> T dslQuery(com.liferay.petra.sql.dsl.query.DSLQuery dslQuery) {
		return _secretKeyLocalService.dslQuery(dslQuery);
	}
	...
	public int dslQueryCount(
		...
		return _secretKeyLocalService.dslQueryCount(dslQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return _secretKeyLocalService.dynamicQueryCount(
			dynamicQuery, projection);
	}

	@Override
	public com.mw.totp_2fa.key.model.SecretKey fetchSecretKey(
		long secretKeyId) {
	...
	public com.mw.totp_2fa.key.model.SecretKey fetchSecretKeyByUserId(
		...
		return _secretKeyLocalService.fetchSecretKeyByUserId(
	...
	public com.mw.totp_2fa.key.model.SecretKey fetchSecretKeyByUuidAndCompanyId(
		...
		return _secretKeyLocalService.fetchSecretKeyByUuidAndCompanyId(
			uuid, companyId);
	}
	...
	public com.mw.totp_2fa.key.model.SecretKey getSecretKeyByUuidAndCompanyId(
		...
		return _secretKeyLocalService.getSecretKeyByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	@Override
	public java.util.List<com.mw.totp_2fa.key.model.SecretKey> getSecretKeys(
		int start, int end) {

		return _secretKeyLocalService.getSecretKeys(start, end);
	}
	...
	public int getSecretKeysCount() {
		return _secretKeyLocalService.getSecretKeysCount();
	}
	...
	public BasePersistence<?> getBasePersistence() {
		return _secretKeyLocalService.getBasePersistence();
	}
