...
public abstract class SecretKeyLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SecretKeyLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.mw.totp_2fa.key.service.SecretKeyLocalServiceUtil</code>.
	 */
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SecretKeyLocalServiceImpl#deleteSecretKey(SecretKey) to avoid orphaned data");
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SecretKeyLocalServiceBaseImpl.class);
